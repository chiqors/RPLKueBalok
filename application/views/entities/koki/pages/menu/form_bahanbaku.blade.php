    ...
    <div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-6">
						<form role="form" action="{{ site_url('koki/menu/bahanbaku/store') }}" enctype="multipart/form-data" method="POST">
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" value="{{ $this->session->info_id_menu }}" name="IdMenu" readonly>
											</div>
											<div class="form-group">
