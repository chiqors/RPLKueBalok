...
<head>
    ...
    <title>{{ getenv('APP_NAME') }} | Panel(Koki) - {{ $title }}</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        @include('entities.koki.includes.header')
        @include('entities.koki.includes.leftsider')
        <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            @include('entities.koki.includes.messages')
            @yield('content')
        </div>
        <!-- /.content-wrapper -->
        @include('entities.koki.includes.footer')
        <!-- /.control-sidebar -->
    </div>
    <!-- ./wrapper -->
