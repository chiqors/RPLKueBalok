...
<head>
    ...
    <title>{{ getenv('APP_NAME') }} | Panel(Owner) - {{ $title }}</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        @include('entities.owner.includes.header')
        @include('entities.owner.includes.leftsider')
        <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            @include('entities.owner.includes.messages')
            @yield('content')
        </div>
        <!-- /.content-wrapper -->
        @include('entities.owner.includes.footer')
        <!-- /.control-sidebar -->
    </div>
    <!-- ./wrapper -->
