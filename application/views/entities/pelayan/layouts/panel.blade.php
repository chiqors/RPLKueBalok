...
<head>
    ...
    <title>{{ getenv('APP_NAME') }} | Panel(Pelayan) - {{ $title }}</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        @include('entities.pelayan.includes.header')
        @include('entities.pelayan.includes.leftsider')
        <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            @include('entities.pelayan.includes.messages')
            @yield('content')
        </div>
        <!-- /.content-wrapper -->
        @include('entities.pelayan.includes.footer')
        <!-- /.control-sidebar -->
    </div>
    <!-- ./wrapper -->
