...
<head>
    ...
    <title>{{ getenv('APP_NAME') }} | Panel(Pantry) - {{ $title }}</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        @include('entities.pantry.includes.header')
        @include('entities.pantry.includes.leftsider')
        <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            @include('entities.pantry.includes.messages')
            @yield('content')
        </div>
        <!-- /.content-wrapper -->
        @include('entities.pantry.includes.footer')
        <!-- /.control-sidebar -->
    </div>
    <!-- ./wrapper -->
